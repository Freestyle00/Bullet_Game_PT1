    ...
    {
        public partial class TreeViewItemRuntime : Bullet_Game_PT1.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Bullet_Game_PT1.GumRuntimes.DefaultForms.TreeViewItemRuntime.VariableState fromState,Bullet_Game_PT1.GumRuntimes.DefaultForms.TreeViewItemRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public Bullet_Game_PT1.GumRuntimes.DefaultForms.TreeViewToggleButtonRuntime ToggleButtonInstance { get; set; }
            public Bullet_Game_PT1.GumRuntimes.DefaultForms.ListBoxItemRuntime ListBoxItemInstance { get; set; }
            ...
            {
                ToggleButtonInstance = this.GetGraphicalUiElementByName("ToggleButtonInstance") as Bullet_Game_PT1.GumRuntimes.DefaultForms.TreeViewToggleButtonRuntime;
                ListBoxItemInstance = this.GetGraphicalUiElementByName("ListBoxItemInstance") as Bullet_Game_PT1.GumRuntimes.DefaultForms.ListBoxItemRuntime;
