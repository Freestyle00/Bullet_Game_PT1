    ...
    {
        public partial class ScrollBarRuntime : Bullet_Game_PT1.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            BackgroundInstance.CurrentColorCategoryState = Bullet_Game_PT1.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                            Height = 384f;
                            Width = 36f;
                            X = 0f;
                            Y = 0f;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = Bullet_Game_PT1.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = Bullet_Game_PT1.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollBarRuntime.VariableState fromState,Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollBarRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollBarRuntime.ScrollBarCategory fromState,Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollBarRuntime.ScrollBarCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Bullet_Game_PT1.GumRuntimes.DefaultForms.ButtonRuntime UpButtonInstance { get; set; }
            public Bullet_Game_PT1.GumRuntimes.DefaultForms.ButtonRuntime DownButtonInstance { get; set; }
            public Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            public Bullet_Game_PT1.GumRuntimes.SpriteRuntime SpriteInstance1 { get; set; }
            public Bullet_Game_PT1.GumRuntimes.SpriteRuntime SpriteInstance2 { get; set; }
            public Bullet_Game_PT1.GumRuntimes.ContainerRuntime ThumbContainer { get; set; }
            ...
            private void AssignReferences () 
            {
                ...
                UpButtonInstance = this.GetGraphicalUiElementByName("UpButtonInstance") as Bullet_Game_PT1.GumRuntimes.DefaultForms.ButtonRuntime;
                DownButtonInstance = this.GetGraphicalUiElementByName("DownButtonInstance") as Bullet_Game_PT1.GumRuntimes.DefaultForms.ButtonRuntime;
                ThumbInstance = this.GetGraphicalUiElementByName("ThumbInstance") as Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollBarThumbRuntime;
                SpriteInstance1 = this.GetGraphicalUiElementByName("SpriteInstance1") as Bullet_Game_PT1.GumRuntimes.SpriteRuntime;
                SpriteInstance2 = this.GetGraphicalUiElementByName("SpriteInstance2") as Bullet_Game_PT1.GumRuntimes.SpriteRuntime;
                ThumbContainer = this.GetGraphicalUiElementByName("ThumbContainer") as Bullet_Game_PT1.GumRuntimes.ContainerRuntime;
