    ...
    {
        public partial class SliderRuntime : Bullet_Game_PT1.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Bullet_Game_PT1.GumRuntimes.DefaultForms.SliderRuntime.VariableState fromState,Bullet_Game_PT1.GumRuntimes.DefaultForms.SliderRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Bullet_Game_PT1.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory fromState,Bullet_Game_PT1.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Bullet_Game_PT1.GumRuntimes.DefaultForms.ColoredFrameRuntime LineInstance { get; set; }
            public Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            public Bullet_Game_PT1.GumRuntimes.ContainerRuntime TrackInstance { get; set; }
            ...
            {
                LineInstance = this.GetGraphicalUiElementByName("LineInstance") as Bullet_Game_PT1.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                ...
                TrackInstance = this.GetGraphicalUiElementByName("TrackInstance") as Bullet_Game_PT1.GumRuntimes.ContainerRuntime;
