    ...
    {
        public partial class ScrollViewerRuntime : Bullet_Game_PT1.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollViewerRuntime.VariableState fromState,Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollViewerRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollViewerRuntime.ScrollBarVisibility fromState,Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollViewerRuntime.ScrollBarVisibility toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollBarRuntime VerticalScrollBarInstance { get; set; }
            public Bullet_Game_PT1.GumRuntimes.ContainerRuntime ClipContainerInstance { get; set; }
            public Bullet_Game_PT1.GumRuntimes.ContainerRuntime InnerPanelInstance { get; set; }
            ...
            private void AssignReferences () 
            {
                ...
                VerticalScrollBarInstance = this.GetGraphicalUiElementByName("VerticalScrollBarInstance") as Bullet_Game_PT1.GumRuntimes.DefaultForms.ScrollBarRuntime;
                ClipContainerInstance = this.GetGraphicalUiElementByName("ClipContainerInstance") as Bullet_Game_PT1.GumRuntimes.ContainerRuntime;
                InnerPanelInstance = this.GetGraphicalUiElementByName("InnerPanelInstance") as Bullet_Game_PT1.GumRuntimes.ContainerRuntime;
