...
{
    public partial class Not_You : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public Not_You (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Not_You (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void Destroy () 
        {
            ...
            if (Used)
            {
                Factories.Not_YouFactory.MakeUnused(this, false);
            }
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Not_YouStaticUnload", UnloadStaticContent);
